...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(React, $) {// import React from 'react'
	...
	var _jsxTestUiButtonTestJsx = __webpack_require__(158);

	var _jsxTestUiButtonTestJsx2 = _interopRequireDefault(_jsxTestUiButtonTestJsx);

	var _jsxTestUiButtonGroupTestJsx = __webpack_require__(161);

	var _jsxTestUiButtonGroupTestJsx2 = _interopRequireDefault(_jsxTestUiButtonGroupTestJsx);

	var _jsxTestUiDropMenuTestJsx = __webpack_require__(163);

	var _jsxTestUiDropMenuTestJsx2 = _interopRequireDefault(_jsxTestUiDropMenuTestJsx);
				...
				return React.createElement(
					...
					React.createElement(
						...
						React.createElement(
							...
							React.createElement(_jsxTestUiButtonTestJsx2['default'], null)
						),
						React.createElement(
							'li',
							null,
							...
							React.createElement(_jsxTestUiButtonGroupTestJsx2['default'], null)
						),
						React.createElement(
							'li',
							null,
							...
							React.createElement(_jsxTestUiDropMenuTestJsx2['default'], null)
						)
					)
				);
			}
	...
	React.render(React.createElement(Test, null), $('#content')[0]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _uiButtonJsx = __webpack_require__(159);

	var _uiButtonJsx2 = _interopRequireDefault(_uiButtonJsx);
	...
	var ButtonTest = (function (_React$Component) {
		...
		function ButtonTest() {
			...
			_get(Object.getPrototypeOf(ButtonTest.prototype), 'constructor', this).apply(this, arguments);
		...
		_createClass(ButtonTest, [{
			...
			value: function render() {
				return React.createElement(
					...
					React.createElement(
						_uiButtonJsx2['default'],
						{ onClick: this.handleOnClick.bind(this), className: 'test1 test2' },
						' ',
						React.createElement(
							'p',
							null,
					...
					React.createElement(_uiButtonJsx2['default'], { onClick: this.handleOnClick1.bind(this), btnStyle: 'primary', btnName: this.state.btnName }),
					React.createElement(_uiButtonJsx2['default'], { onClick: this.handleOnClick.bind(this), btnSize: 'lg' }),
					React.createElement(_uiButtonJsx2['default'], { onClick: this.handleOnClick.bind(this), btnState: 'disabled', btnStyle: 'danger' }),
					React.createElement(_uiButtonJsx2['default'], { onClick: this.handleOnClick.bind(this), isBtnBlock: true }),
					React.createElement(_uiButtonJsx2['default'], { onClick: this.handleOnClick.bind(this), renderElement: 'a', btnStyle: 'danger', href: 'http://www.baidu.com' }),
					React.createElement(_uiButtonJsx2['default'], { onClick: this.handleOnClick.bind(this), renderElement: 'input', btnType: 'submit', btnStyle: 'danger', btnState: 'disabled' }),
					React.createElement(_uiButtonJsx2['default'], { onClick: this.handleOnClick.bind(this), renderElement: 'input', btnType: 'reset', btnStyle: 'danger', btnState: 'disabled' })
				);
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(React, Classnames) {'use strict';
	...
	var Button = (function (_React$Component) {
		...
		_createClass(Button, [{
			...
			value: function getClassNames() {
				var className = Classnames('btn', 'btn-' + this.props.btnStyle, this.props.btnSize === 'default' ? null : 'btn-' + this.props.btnSize, this.props.btnState === 'default' ? null : this.props.btnState, this.props.isBtnBlock ? 'btn-block' : null, this.props.isBtnDropDown ? 'dropdown-toggle' : null, this.props.className);
			...
			value: function render() {
				...
				var Component = this.props.renderElement;
				return React.createElement(
					Component,
					{
	...
	module.exports = exports['default'];
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(1), __webpack_require__(160)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _uiButtonGroupJsx = __webpack_require__(162);

	var _uiButtonGroupJsx2 = _interopRequireDefault(_uiButtonGroupJsx);

	var ButtonGroupTest = (function (_React$Component) {
		_inherits(ButtonGroupTest, _React$Component);

		function ButtonGroupTest() {
			_classCallCheck(this, ButtonGroupTest);

			_get(Object.getPrototypeOf(ButtonGroupTest.prototype), 'constructor', this).apply(this, arguments);
		}

		_createClass(ButtonGroupTest, [{
			key: 'render',
			value: function render() {
				...
				return React.createElement(
					...
					null,
					React.createElement(
						_uiButtonGroupJsx2['default'],
						{ isJustified: true },
						React.createElement(
							_uiButtonJsx2['default'],
							{ className: 'test1 test2', btnName: 'isJustified', renderElement: 'a' },
							' '
						),
						React.createElement(_uiButtonJsx2['default'], { btnStyle: 'primary', btnName: 'isJustified', renderElement: 'a' })
					),
					React.createElement(
						_uiButtonGroupJsx2['default'],
						{ isToolBar: true },
						React.createElement(
							...
							React.createElement(
								_uiButtonJsx2['default'],
								{ className: 'test1 test2', btnName: 'isToolBar-1' },
								' '
							),
							React.createElement(_uiButtonJsx2['default'], { btnStyle: 'primary', btnName: 'isToolBar-1' })
						),
						React.createElement(
							_uiButtonGroupJsx2['default'],
							null,
							React.createElement(
								_uiButtonJsx2['default'],
								{ className: 'test1 test2', btnName: 'isToolBar-2' },
								' '
							),
							React.createElement(_uiButtonJsx2['default'], { btnStyle: 'primary', btnName: 'isToolBar-2' })
						),
						React.createElement(
							_uiButtonJsx2['default'],
							{ className: 'test1 test2', btnName: 'isToolBar-3 ' },
							' '
						),
						React.createElement(_uiButtonJsx2['default'], { btnStyle: 'primary' })
					),
					React.createElement(
						_uiButtonGroupJsx2['default'],
						{ isVertical: true },
						React.createElement(_uiButtonJsx2['default'], { btnSize: 'lg', btnName: 'isVertical-2' }),
						React.createElement(_uiButtonJsx2['default'], { btnState: 'disabled', btnStyle: 'danger', btnName: 'isVertical-2' }),
						React.createElement(_uiButtonJsx2['default'], { isBtnBlock: true, btnName: 'isVertical-2' })
					)
				);
			}
		}]);

		return ButtonGroupTest;
	})(React.Component);

	exports['default'] = ButtonGroupTest;
	module.exports = exports['default'];
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(1)))
	...
	var ButtonGroup = (function (_React$Component) {
		...
		_createClass(ButtonGroup, [{
			...
			value: function render() {
				...
				var classNameVar = Classnames(this.props.isToolBar ? 'btn-toolbar' : this.props.isVertical ? 'btn-group-vertical' : 'btn-group', this.props.isJustified ? 'btn-group-justified' : null);
				return React.createElement(
					'div',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _uiDropDownMenuJsx = __webpack_require__(164);

	var _uiDropDownMenuJsx2 = _interopRequireDefault(_uiDropDownMenuJsx);

	var _uiDropDownMenuItemJsx = __webpack_require__(165);

	var _uiDropDownMenuItemJsx2 = _interopRequireDefault(_uiDropDownMenuItemJsx);

	var DropMenuTest = (function (_React$Component) {
		_inherits(DropMenuTest, _React$Component);

		function DropMenuTest() {
			_classCallCheck(this, DropMenuTest);

			_get(Object.getPrototypeOf(DropMenuTest.prototype), 'constructor', this).apply(this, arguments);
		...
		_createClass(DropMenuTest, [{
			...
			key: 'onClickMenuItem',
			value: function onClickMenuItem(event, key) {
				alert(key);
			...
			value: function render() {
				...
				return React.createElement(
					...
					null,
					React.createElement(
						_uiDropDownMenuJsx2['default'],
						{ isUp: true, isOpen: this.state.isOpen, triggerElement: React.createElement(
								_uiButtonGroupJsx2['default'],
								null,
								React.createElement(
									_uiButtonJsx2['default'],
						...
						React.createElement(
							_uiDropDownMenuItemJsx2['default'],
							{ key: 1 },
							'test1'
						),
						React.createElement(_uiDropDownMenuItemJsx2['default'], { key: 2, isSeparator: true }),
						React.createElement(
							_uiDropDownMenuItemJsx2['default'],
							{ key: 3 },
							'test3'
	...
	var DropDownMenu = (function (_React$Component) {
		...
		_createClass(DropDownMenu, [{
			...
			value: function render() {
				...
				var classNameVar = Classnames(this.props.isUp ? 'dropup' : 'dropdown', { 'open': this.state.isOpen }, this.props.className);

				var listElement = [];
				React.Children.forEach(this.props.children, (function (child) {

					listElement.push(React.cloneElement(child, { eventKey: child.key, onClick: this.onClickMenuItem.bind(this) }));
				}).bind(this));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DropDownMenuItem = (function (_React$Component) {
		...
		function DropDownMenuItem() {
			...
			_get(Object.getPrototypeOf(DropDownMenuItem.prototype), 'constructor', this).apply(this, arguments);
		...
		_createClass(DropDownMenuItem, [{
			...
			value: function render() {
				...
				var isSeparator = _props.isSeparator;
				var disabled = _props.disabled;
				var children = _props.children;
				var className = _props.className;

				var other = _objectWithoutProperties(_props, ['isSeparator', 'disabled', 'children', 'className']);

				var classNameVar = Classnames({ 'divider': this.props.isSeparator }, { 'disabled': this.props.disabled }, this.props.className);

				return React.createElement(
					'li',
					{ className: classNameVar },
					this.props.isSeparator ? undefined : React.createElement(
						'a',
						_extends({}, this.other, { onClick: this.handleOnClick.bind(this) }),
						this.props.children
					)
				);
			}
