...
/***/ function(module, exports, __webpack_require__) {
	...
	//注意：React 的组件 首字母一定要大写
	// import React from 'react'
	'use strict';

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { 'default': obj }; }

	var _jsxReactmainJsx = __webpack_require__(158);

	var _jsxReactmainJsx2 = _interopRequireDefault(_jsxReactmainJsx);

	React.render(React.createElement(_jsxReactmainJsx2['default'], null), $('#content')[0]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _routesComponentsIndexJsx = __webpack_require__(162);

	var _routesComponentsIndexJsx2 = _interopRequireDefault(_routesComponentsIndexJsx);

	var _routesComponentsUserJsx = __webpack_require__(164);

	var _routesComponentsUserJsx2 = _interopRequireDefault(_routesComponentsUserJsx);

	var _componentsErrorJsx = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./components/error.jsx\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));

	var _componentsErrorJsx2 = _interopRequireDefault(_componentsErrorJsx);
	...
	var Main = (function (_React$Component) {
		...
		function Main() {
			...
			this.state = _jsRoutesJs2['default'].getUrl();
			console.log(this.state);
		}

		_createClass(Main, [{
			key: 'getPathAndParam',
			value: function getPathAndParam() {}
		}, {
			key: 'handleChangePath',
			value: function handleChangePath(path) {
				this.setState(_jsRoutesJs2['default'].getUrl());
			}
		}, {
			...
			value: function renderUser() {
				return React.createElement(_routesComponentsUserJsx2['default'], { componentArray: this.state.componentArray.slice(1) });
			}
		}, {
			key: 'renderIndex',
			value: function renderIndex() {

				return React.createElement(_routesComponentsIndexJsx2['default'], { componentArray: this.state.componentArray.slice(1) });
			}
		}, {
			key: 'renderError',
			value: function renderError() {
				return React.createElement(_componentsErrorJsx2['default'], { componentName: this.state.componentArray[0] });
			}
		}, {
			key: 'render',
			value: function render() {
				var handleName = 'render' + (this.state.componentArray[0] ? this.state.componentArray[0].replace(/(\w)/, function (v) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _cookieJs = __webpack_require__(161);
...
/***/ function(module, exports) {
	...
	var CookieHelp = (function () {
		function CookieHelp() {
			_classCallCheck(this, CookieHelp);
		}

		_createClass(CookieHelp, [{
			key: "setCookie",
			...
			key: "deleteCookie",
			value: function deleteCookie(c_name) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _baseRoutesJsx = __webpack_require__(163);

	var _baseRoutesJsx2 = _interopRequireDefault(_baseRoutesJsx);

	var _componentsPageNavBarJsx = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"../components/pageNavBar.jsx\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));

	var _componentsPageNavBarJsx2 = _interopRequireDefault(_componentsPageNavBarJsx);

	var _componentsPageSearchJsx = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"../components/pageSearch.jsx\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));

	var _componentsPageSearchJsx2 = _interopRequireDefault(_componentsPageSearchJsx);

	var _componentsShelfJsx = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"../components/shelf.jsx\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));

	var _componentsShelfJsx2 = _interopRequireDefault(_componentsShelfJsx);
	...
	var Index = (function (_BaseRoutes) {
		...
		_createClass(Index, [{
			...
			value: function handleclick() {
				_jsRoutesJs2['default'].gotoPath('/user');
			}
		}, {
			key: 'renderIndex',
			value: function renderIndex() {
				return React.createElement(
					'div',
					null,
					React.createElement(_componentsPageNavBarJsx2['default'], null),
					React.createElement(_componentsPageSearchJsx2['default'], null),
					React.createElement(_componentsShelfJsx2['default'], null)
				);
			}
		}]);

		return Index;
	})(_baseRoutesJsx2['default']);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BaseRoutes = (function (_React$Component) {
		_inherits(BaseRoutes, _React$Component);

		function BaseRoutes() {
			_classCallCheck(this, BaseRoutes);

			_get(Object.getPrototypeOf(BaseRoutes.prototype), 'constructor', this).apply(this, arguments);
		}

		_createClass(BaseRoutes, [{
			key: 'renderError',
			value: function renderError() {
				return React.createElement(_componentsErrorJsx2['default'], { componentName: this.props.componentArray[0] });
			}
		}, {
			key: 'render',
			value: function render() {
				console.log(this.props);
				var handleName = 'render' + (this.props.componentArray[0] ? this.props.componentArray[0].replace(/(\w)/, function (v) {
					return v.toUpperCase();
				}) : 'Index');
				if (!this[handleName]) {
					handleName = 'renderError';
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsLoginJsx = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"../components/login.jsx\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
	...
	var User = (function (_BaseRoutes) {
		_inherits(User, _BaseRoutes);
		...
		_createClass(User, [{
			...
			value: function renderLogin() {
				return React.createElement(_componentsLoginJsx2['default'], { activeKey: 1 });
			}
		}, {
			key: 'renderRegister',
			value: function renderRegister() {
				return React.createElement(_componentsLoginJsx2['default'], { activeKey: 2 });
			}
		}]);
